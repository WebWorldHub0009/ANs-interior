...
// Team members with placeholders
const teamMembers = [
  { name: "Bharat Bhatia", role: "CEO", linkedin: "#" },
  { name: "Chanda Bhatia", role: "Director", linkedin: "#" },
  { name: "Kailash Bhatia", role: "Founder", linkedin: "#" },
  { name: "Pooja Bhatia", role: "Financer", linkedin: "#" },
  { name: "Dhruv Bhatia", role: "Manager", linkedin: "#" },
];
...
export default function OurTeamAns() {
  return (
    <section
    ...
    >
      ...
      >
        ...
        <motion.p
          ...
          style={{ color: colors.charcoal }}
        >
          The Ans Interior team blends creativity, expertise, and dedication to deliver
          luxurious and functional interior solutions.
        </motion.p>
      </motion.div>
...
function ProfileCard({ member, colors }) {
  return (
    <motion.div
      ...
      className="flex flex-col items-center space-y-3 p-6 bg-white rounded-3xl shadow-lg relative"
    >
      <motion.div
        {...floatAnimation}
        className="w-32 h-32 rounded-full shadow-xl flex items-center justify-center border-4 border-gold bg-[#fdf5e6]"
      >
        <FaUser className="text-6xl text-[#800000]" />
      </motion.div>

      <h4 className="font-bold text-2xl" style={{ color: colors.maroon }}>
        {member.name}
      </h4>
      <p className="text-lg text-[#1C1C1C]">{member.role}</p>
